% function success = XMLWriter_framework(filename,xmlstruct)
%
...
function [success errormessage xmlstringlength] = XMLWriter_framework(filename,xmlstruct)
...
%% generate xmlstring
[xmlstring success] = MakeXMLString_framework(xmlstruct);
