% function xml = XMLParser_framework(filecontent)
%
...
function [xml restofstring] = XMLParser_framework(xmlstring, start_tag)
...
while true
    ...
    if strcmp(xml_bits{1}{2},['/' start_tag])
        ...
        dataholder = false;
        [newdata current_content] = XMLParser_framework(xml_bits{1}{3}, xml_bits{1}{2});
